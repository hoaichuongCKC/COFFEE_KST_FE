...
class CancledOrderView extends StatelessWidget {
  const CancledOrderView({super.key});
      ...
      builder: (context, state) {
        ...
        if (state.stateApi is SuccessState) {
          return ListView.separated(
            ...
            itemCount: state.listCancled.length,
            itemBuilder: (BuildContext context, int index) {
              return ItemInvoice(
                invoiceModels: state.listCancled[index],
                index: index,
